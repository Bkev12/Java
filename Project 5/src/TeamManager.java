...
public class TeamManager {
	...
	private void loadTeams() {
		...
		while(malesRemaining > 0 && femalesRemaining > 0){
			...
			//create team
			Team team = new Team(teamCounter + 1, olympians[maleIndex], olympians[femaleIndex]);
			//set team in array
		...
		while(totalRemaining > 0){
			...
			//create team
			Team team = new Team(teamCounter + 1, olympians[firstIndex], olympians[secondIndex]);
			//set team in array
			teams[teamCounter] = team;
			//increment counter
			teamCounter++;
	...
	public void printTeams() {
		...
		for (int i = 0; i < teams.length; i++) {
			...
			//display number
			System.out.print("Team #" + team.getTeamNumber() + ": ");
			//display olympian details
			System.out.print(team.getOlympian1().getName() + ",");
			System.out.print(team.getOlympian1().getSex() + ",");
			System.out.print(team.getOlympian1().getAge() + ",");
			System.out.print(team.getOlympian2().getName() + ",");
			System.out.print(team.getOlympian2().getAge() + ",");
			System.out.print(team.getOlympian2().getSex() + ",");
			System.out.print(team.getWins() + ",");
